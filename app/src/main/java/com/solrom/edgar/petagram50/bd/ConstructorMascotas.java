...
public class ConstructorMascotas {
    private static String TAG = "com.solrom.edgar.petagram";
    ...
    public void darlikeMascota(Mascota mascota)
    {
        ...
        int nuevoLike = mascota.getLikes() + 1;
        Log.d(TAG, String.valueOf(nuevoLike));

        contentValues.put(ConstantesBaseDatos.TABLA_LIKES_MASCOTA_NUMERO_LIKES, nuevoLike);

        db.actualizaMascotaLikes(contentValues, mascota);
